...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \fill [rounded corners=2pt, fill=mid] (-4.5 + \dx, -5) rectangle +(9, 10);
  \node at (\dx, -4) [text=white] {Environment};
  
  \draw [rounded corners=2pt, color=dark, dashed] (-4 + \dx, -2.5) rectangle +(16, 5);
  \node at (8 +\dx, 0) [text=dark] {Probe 1};
  ...
  \draw [rounded corners=2pt, color=dark, dashed] (-4 + \dx, -2.5) rectangle +(8, 11.5);
  \node at (\dx, 7) [text=dark] {Probe 2};
  ...
  \draw [rounded corners=2pt, color=dark, dashed] (4 + \dx, -2.5) rectangle +(-16, 5);
  \node at (-8 +\dx, 0) [text=dark] {Probe 3};
