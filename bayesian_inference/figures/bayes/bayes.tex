...
\begin{tikzpicture}[scale=0.3, thick]   
 ...
 \foreach \i in {0.025, 0.05, ..., 1} {
  ...
  \draw [color=dark, line width=1.5, dashed] (-5.2 + \dx, -2) 
  ...
  \begin{scope}
    ...
    \foreach \i in {0, 0.025,..., 1} {
      \fill[opacity={exp(-5 * \i*\i)}, dark] (-2 + \dx, 0.5) circle ({5 * \i});      
    }
  \end{scope}
  
  \node [color=white] at (4.5 + \dx, 0.75) { $\pi_{\mathcal{S}}(\theta)$ };
 ...
 \foreach \i in {0.025, 0.05, ..., 1} {
  ...
  \begin{scope}
    ...
    \foreach \i in {0, 0.05,..., 1} {
      \fill[opacity={exp(-5 * \i*\i)}, dark] (0 + \dx, 0) circle ({2 * \i});      
    }
  \end{scope}
    
  \node [color=white] at (5 + \dx, 0.75) { $\pi_{\mathcal{S}}(\theta \mid \tilde{y})$ };
