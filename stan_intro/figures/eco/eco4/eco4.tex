...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \fill [rounded corners=2pt, fill=dark, text=white] (-25, 0) rectangle +(-10, 5) 
  node[midway, align=center] { Stan\\Interfaces };
  
  \draw[line width=12, -{Triangle[width=17,length=10]}] (-12.5, 1.66) -- +(-12.75, 0);
  \draw[line width=10, -{Triangle[width=13.5,length=8]}, white] (-12.5, 1.66) -- +(-12.61, 0);
  
  \node[] at (-18.75, 1.66) { Fit Results };
  
  \fill [rounded corners=2pt, fill=dark, text=white] (-2.5, 0) rectangle +(-10, 5) 
  node[midway, align=center] { Compiled\\Executable };
  
  \draw[line width=12, -{Triangle[width=17,length=10]}] (-25, 3.33) -- +(12.75, 0);
  \draw[line width=10, -{Triangle[width=13.5,length=8]}, white] (-25, 3.33) -- +(12.61, 0);
  
  \node[] at (-18.75, 3.33) { Data and Configuration };
