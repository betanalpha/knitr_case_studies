...
\begin{tikzpicture}[scale=0.25, thick]
  ...
  \node[] at (30,-2) {\includegraphics[width=5cm]{gnuplot/funnel_trace3.eps}};
  ...
  \draw[-,color=gray60, line width=0.5] (47.625, 4)
                                       .. controls (49, 1.5) and (56, 1.5) 
                                       .. (59.3, 1.5);
  \draw[-,color=gray60, line width=0.5] (59.3, 1.5) 
                                       .. controls (62.8, 1.5) and (63.25, -1.5) 
                                       .. (65.1, -3.5);
  \draw[-,color=black, line width=0.5] (65.1, -3.5)
                                       .. controls (61 + 5, -4.25) and (62 + 5, -1.25)
                                       .. (67.975, 1);
\end{tikzpicture}
