...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \draw [color=gray80, dashed] (27, 4.5) circle (4); 
  \draw [color=gray80, dashed] (28, 5.5) circle (4);   
  
  \begin{scope}
  	\clip (27, 4.5) circle (4);
	\fill [color=dark] (28, 5.5) circle (4);
  \end{scope}
  \node [text=white] at (27.5, 5) {$A_{1} \cap A_{2}$};
