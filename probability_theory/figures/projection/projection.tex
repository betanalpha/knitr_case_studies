...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \fill [color=light] (-14.03, 4.9) .. controls (-8, 10) and (5, 9) .. (13.6, 3.44) 
                       -- (8.71, 3.6) .. controls (2, 6) and (-4, 7) .. (-11.54, 1.8);
  ...
  \begin{scope}
    ...
    node[midway, xshift=-8, yshift=-10] { $B = \varpi(A)$ };
  \end{scope}
  
  %\draw [color=dark, line width=1.5] (-10, 0) .. controls +(-1, 3) .. +(1, 5) .. 
