...
\begin{tikzpicture}[scale=0.3, thick]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \node at (0, 17) { Soft Containment Prior Model };
  ...
  \begin{scope}[shift={(27, 0)}]
    ...
    \node at (0, 17) { Hard Containment Prior Model };
    ...
    \draw[dark, line width=1] (-9.7, 0.05) -- (-5.45, 0.05) -- (-5.45, 7) -- (5.45, 7) -- (5.45, 0.05) -- (9.7, 0.05);
