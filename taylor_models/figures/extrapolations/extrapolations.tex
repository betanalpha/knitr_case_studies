...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-4.6, -3) rectangle (4.6, 3.25);
    ...
    \begin{scope}
      ...
      \colorlet{custom}{dark!95!white};
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) + 0.4 * \x * \x)});
      
      \colorlet{custom}{dark!92.5!white};  
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) - 0.1 * \x * \x + 0.25 * \x * \x * \x)});       

      \colorlet{custom}{dark!90!white};
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) - 0.1 * \x * \x + 0.1 * \x * \x * \x)});  

      \colorlet{custom}{dark!87.5!white};
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) + 0.25 * \x * \x * \x + 0.1 * \x * \x * \x * \x * \x)});   

      \colorlet{custom}{dark!85!white};
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) - 0.1 * \x * \x - 0.5 * \x * \x * \x)});   

      \colorlet{custom}{dark!82.5!white};
      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=custom] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo) - 1.25 * \x * \x * \x + 0.25 * \x * \x * \x * \x * \x)});  

      \draw[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=light] 
        plot ({\x},{\ys * (\fo + \dfdxo * (\x - \xo))});
    \end{scope}
    
    \node[light] at (3.75, -1.9) { $f_{1}(x; x_{0})$ };
