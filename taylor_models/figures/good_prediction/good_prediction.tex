...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \node[dark_teal] at (0, -2.25) { $\pi_{\text{complete}}(x)$ };

    \fill[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=light_teal] 
      plot ({\x},{0.33 * normal( (\x + 0.2) / 0.1 ) / 0.1 - 2});
    \node[light_teal] at (-1.4, -1.5) { $\pi_{\text{incomplete}}(x)$ };
  ...
  \begin{scope}[shift={(9, 0)}]
    ...
    \fill[domain={-3:3}, smooth, samples=150, line width=1.25, variable=\x, color=dark_teal] 
      plot ({\x},{0.33 * normal( (\x - 0.2) / 0.1 ) / 0.1 - 2});
    \node[dark_teal] at (0.2, -2.25) { $\pi_{\text{complete}}(x)$ };
