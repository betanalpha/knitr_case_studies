...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-4.25, -3) rectangle (4.25, 3.5);
    ...
    \node[light] at (2.5, -0.85) { $f_{1}(x; x_{0})$ };
     ...
     \foreach \x/\y in {0.333/-0.930, -0.228/0.633, 0.388/-0.739, 0.172/-0.339, -0.302/0.676, 
                        0.664/-0.942, -0.013/-0.333, 0.293/-0.399, 0.275/-0.584, -0.228/0.160} {
       \fill[dark_teal] (\x, \ys * \y) circle(0.05);
    }
    \node[dark_teal, align=center] at (0, -0.85) { Complete\\Observations};
    
    \foreach \x/\y in {-1.945/4.337, -1.798/3.689, -2.125/3.973, -2.164/4.468, -2.156/4.647, 
    									 -1.861/3.560, -2.003/3.902, -2.094/4.380, -2.389/4.724, -2.455/4.957} {
       \fill[mid_teal] (\x, \ys * \y) circle(0.05);
    }
    \node[mid_teal, align=center] at (-1.75, 2.55) { \\Incomplete\\Observations\\With Predicted\\Variates};
