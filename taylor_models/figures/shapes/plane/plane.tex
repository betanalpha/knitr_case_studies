...
\begin{scope}[shift={(0, 0)}]
  ...
  \foreach \y in {-3, -2.99, ..., 0} {
    \pgfmathsetmacro{\prop}{-50 * \y)};
    \colorlet{custom}{darkteal!\prop!white};
    \draw[custom]
        ({x(-\delta, \y, \delta + \y, \theta, \phi)}, 
         {y(-\delta, \y, \delta + \y, \theta, \phi)}) 
     -- ({x(\y + \delta, \y, -\delta, \theta, \phi)}, 
         {y(\y + \delta, \y, -\delta, \theta, \phi)} );
  }
  
  \foreach \y in {0, 0.01, ..., 3} {
    \pgfmathsetmacro{\prop}{50 * \y)};
    \colorlet{custom}{dark!\prop!white};
    \draw[custom]
        ({x(\y - \delta, \y, \delta, \theta, \phi)}, 
         {y(\y - \delta, \y, \delta, \theta, \phi)}) 
     -- ({x(\delta, \y, \y - \delta, \theta, \phi)}, 
         {y(\delta, \y, \y - \delta, \theta, \phi)} );
  }
