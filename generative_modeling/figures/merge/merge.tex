...
\begin{tikzpicture}[scale=0.2, thick]
  ...
  \begin{scope}[shift={(56, 0)}]
    ...
    \node[align=center] at (2, 33) { Overlapping\\Narratively Generative Models };
  
    \pgfmathsetmacro{\deltax}{0.75}
    \pgfmathsetmacro{\deltay}{0.75}
    \coordinate (AA) at (0 + \deltax, 0 + \deltay);
    \coordinate (BB) at (-4 + \deltax, 8 + \deltay);
    \coordinate (CC) at (3 + \deltax, 10 + \deltay);
   ...
   \foreach \B/\E in {AA/BB, AA/CC, BB/CC, CC/H} {
      \draw[-{Stealth[length=6pt, width=6pt]}, shorten <=12.1, shorten >=12, color=mid, line width=1.5] (\B) -- (\E);
    }
    
    \filldraw[fill=white, draw=dark, line width=1.5] (AA) circle (\r);
    \filldraw[fill=white, draw=dark, line width=1.5] (BB) circle (\r);
    \filldraw[fill=white, draw=dark, line width=1.5] (CC) circle (\r);

    \foreach \B/\E in {A/B, A/C, B/C, B/D, C/D, D/E, D/F, D/G} {
      \draw[-{Stealth[length=6pt, width=6pt]}, shorten <=12.1, shorten >=12, color=mid, line width=1.5] (\B) -- (\E);
    }
    
    \draw[-{Stealth[length=6pt, width=6pt]}, shorten <=12.1, shorten >=14.5, color=mid, line width=1.5] (CC) -- (I);
    \draw[-{Stealth[length=6pt, width=6pt]}, shorten <=12.1, shorten >=12, color=mid, line width=1.5] (H) -- (I);
  ...
  \begin{scope}[shift={(84, 0)}]
    ...
    \node[align=center] at (2, 33) { Merged Joint\\Narratively Generative Model };
