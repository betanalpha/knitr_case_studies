...
\begin{scope}[shift={(0, 0)}]
  ...
  \node[dark] at (-16.25, 3) { $\mathbb{P}_{f_{*} \pi}[I(y_{\text{min}}, f(x_{1}))]$ };

  \draw[dark, dashed] (-11, 6) -- (1, 6);
  \node[dark] at (-16.25, 6) { $\mathbb{P}_{f_{*} \pi}[I(y_{\text{min}}, f(x_{2}))]$ };
  
  \draw[dark, dashed] (-11, 9) -- (5, 9);
  \node[dark] at (-16.25, 9) { $\mathbb{P}_{f_{*} \pi}[I(y_{\text{min}}, f(x_{3}))]$ };
