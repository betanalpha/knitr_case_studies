...
\begin{tikzpicture}[scale=0.3]
  ...
  \draw[domain=-13:13, smooth, samples=150, line width=1, variable=\x, color=light] 
    plot ({\x + \dx}, {\x * \x * \x / 350});

  \draw [->, >=stealth, line width=1] (-13 + \dx, -8) -- +(26, 0);
  \draw [->, >=stealth, line width=1] (-13 + \dx, -8.058) -- +(0, 16);
  \node[] at (0 + \dx, -10) { $x$ };
  \node[dark] at (-15 + \dx, -1) { $f(x)$ };
  \node[light] at (-15 + \dx, 1) { $g(x)$ };
  
  \pgfmathsetmacro{\dx}{34}
  
  \draw[white] (-17 + \dx, -12) rectangle (15 + \dx, 10);

  \draw[dashed, gray70, line width=2] (-13 + \dx, 0) -- +(26, 0);
  \draw[domain=-13:13, smooth, samples=150, line width=1, variable=\x, color=dark] 
    plot ({\x + \dx}, {sin(\x * 50)});
  ...
  \draw [->, >=stealth, line width=1] (-13 + \dx, -8.058) -- +(0, 16);
  \node[] at (0 + \dx, -10) { $x$ };
  \node[text=black, rotate=90] at (-16 + \dx, 0) { $f(x) - g(x)$ };
  \node[] at (-14 + \dx, 0) { $0$ };
  ...
  \foreach \x in {-9.75, -6.5, ..., 9.75} {
    ...
    \fill[color=dark] (\x + \dx, {sin(\x * 50)}) circle (0.25);
    \draw[color=white] (\x + \dx, {sin(\x * 50)}) circle (0.25);
  }
