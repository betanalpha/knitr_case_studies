...
\node[right] at (-7.75, 10.5) { $k'' \in \mathfrak{K}_{\text{NCP}}$ };
...
\node[] at (15, 0)    { $\theta_{k''} = \mu + \tau \cdot \eta_{k''}$ };
\node[] at (15, -5)   { $\eta_{k''} \sim \text{normal}(0, 1)$ };

\end{scope}

\draw[->, >=stealth, color=mid, line width=1.5] (10, -10) -- ({26 - \r * cos(30)}, {0 - \r * sin(30)});
\draw[->, >=stealth, color=mid, line width=1.5] (10, -10) -- ({0 + \r * cos(50)}, {0 - \r * sin(50)});

\filldraw[fill=white, draw=dark, line width=1.5] (10, -10) circle (\r)
node[color=black] { $\mu$ };

\draw[->, >=stealth, color=mid, line width=1.5] (16, -10) -- ({26 - \r * cos(50)}, {0 - \r * sin(50)});
\draw[->, >=stealth, color=mid, line width=1.5] (16, -10) -- ({0 + \r * cos(30)}, {0 - \r * sin(30)});

\filldraw[fill=white, draw=dark, line width=1.5] (16, -10) circle (\r)
node[color=black] { $\tau$ };
