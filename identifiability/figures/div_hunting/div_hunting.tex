...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \begin{scope}
    ...
    \node at (0 + \dx, 0) {\includegraphics[width=3.5cm]{gnuplot/density.eps}};
  \end{scope}
  ...
  \begin{scope}
    \clip (-7 + \dx, -9) rectangle (7 + \dx, 6);
    \node at (0 + \dx, 0) {\includegraphics[width=3.5cm]{gnuplot/crude_samples.eps}};
  \end{scope}
  ...
  \node[] at (0 + \dx, -8) { Nominal Step Size Adaptation };
  ...
  \begin{scope}
    \clip (-7 + \dx, -9) rectangle (7 + \dx, 6);
    \node at (0 + \dx, 0) {\includegraphics[width=3.5cm]{gnuplot/refined_samples.eps}};
  \end{scope}
  ...
  \node[] at (0 + \dx, -8) { Refined Step Size Adaptation };
