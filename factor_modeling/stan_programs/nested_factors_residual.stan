...
transformed data {
  // Expand nesting to simplify residual summation
  int<lower=1, upper=N_factor2_levels> obs_to_factor2[N] 
    = factor3_to_factor2[obs_to_factor3];
  int<lower=1, upper=N_factor2_levels> obs_to_factor1[N] 
    = factor2_to_factor1[obs_to_factor2];
}
