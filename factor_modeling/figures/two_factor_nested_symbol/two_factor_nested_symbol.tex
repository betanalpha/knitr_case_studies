...
\draw[light, rounded corners=5, line width=1.5] (-12 - 5, 14 - 5) rectangle +(22, 10);
\draw[light, rounded corners=5, line width=1.5] (12 - 5, 14 - 5) rectangle +(10, 10);

\draw[mid, rounded corners=5, line width=1.5] (-18 - 5, 0 - 5) rectangle +(10, 10);
\draw[mid, rounded corners=5, line width=1.5] (-6 - 5, 0 - 5) rectangle +(22, 10);
\draw[mid, rounded corners=5, line width=1.5] (18 - 5, 0 - 5) rectangle +(10, 10);

\draw[dark, rounded corners=5, line width=1.5] (-24 - 5, -14 - 5) rectangle +(34, 10);
\draw[dark, rounded corners=5, line width=1.5] (12 - 5, -14 - 5) rectangle +(22, 10);
