...
\draw[light, rounded corners=5] (-27.5, 11 - 5) rectangle (27.5, 11 + 5);
\draw[mid, rounded corners=5] (-27.5, 0 - 5) rectangle (27.5, 0 + 5);
\draw[dark, rounded corners=5] (-27.5, -11 - 5) rectangle (27.5, -11 + 5);
...
%\draw[] (0, 0) circle (5 and 3.5);

\draw[dark, line width=2, ->, >=stealth]
   (-2.5, 3.05) 
   .. controls (-2, 3.25) and (-1.25, 3.5) 
   .. (0, 3.5)
   .. controls (2.25, 3.5) and (3.25, 2.75)
   .. (3.8, 2.25);

\draw[dark, line width=2, <-, >=stealth] 
  (-3.9, -2.2) 
  .. controls (-3.25, -2.6) and (-2, -3.5) 
  .. (0, -3.5)
  .. controls (2, -3.5) and (2.6, -3)
  .. (3, -2.8);
