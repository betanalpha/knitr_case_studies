...
\draw[->, >=stealth, color=black, line width=2] (65 + 2.25 + 5 * 4.5, 0 + \r) -- (65 + 2.25 + 5 * 4.5, 16 - \r);
\draw[->, >=stealth, color=black, line width=2] (65 + 2.25 + 5 * 4.5, 0 + \r) -- (65 + 2.25 + 4 * 4.5, 16 - \r);

\draw[->, >=stealth, color=gray70, line width=2] (65 + 2.25 + 4 * 4.5, 0 + \r) -- (65 + 2.25 + 3 * 4.5, 16 - \r);

\draw[->, >=stealth, color=gray70, line width=2] (65 + 2.25 + 3 * 4.5, 0 + \r) -- (65 + 2.25 + 2 * 4.5, 16 - \r);

\draw[->, >=stealth, color=gray70, line width=2] (65 + 2.25 + 2 * 4.5, 0 + \r) -- (65 + 2.25 + 1 * 4.5, 16 - \r);

\draw[->, >=stealth, color=black, line width=2] (65 + 2.25, 0 + \r) -- (65 + 2.25, 16 - \r);
\draw[->, >=stealth, color=black, line width=2] (65 + 2.25, 0 + \r) -- (65 - 2.25, 16 - \r);
\draw[->, >=stealth, color=black, line width=2] (65 + 2.25, 0 + \r) -- (65 - 2.25 - 1 * 4.5, 16 - \r);

\draw[->, >=stealth, color=gray70, line width=2] (65 - 2.25 - 1 * 4.5, 0 + \r) -- (65 - 2.25 - 2 * 4.5, 16 - \r);

\draw[->, >=stealth, color=black, line width=2] (65 - 2.25 - 4 * 4.5, 0 + \r) -- (65 - 2.25 - 3 * 4.5, 16 - \r);
\draw[->, >=stealth, color=black, line width=2] (65 - 2.25 - 4 * 4.5, 0 + \r) -- (65 - 2.25 - 4 * 4.5, 16 - \r);

\draw[->, >=stealth, color=gray70, line width=2] (65 - 2.25 - 5 * 4.5, 0 + \r) -- (65 - 2.25 - 5 * 4.5, 16 - \r);
