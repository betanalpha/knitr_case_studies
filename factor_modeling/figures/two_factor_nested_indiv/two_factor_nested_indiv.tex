...
\draw[light, rounded corners=5, line width=1.5] (-12 - 4, 14 - 4) rectangle +(8, 8);
\draw[light, rounded corners=5, line width=1.5] (0 - 4, 14 - 4) rectangle +(8, 8);
\draw[light, rounded corners=5, line width=1.5] (12 - 4, 14 - 4) rectangle +(8, 8);

\draw[mid, rounded corners=5, line width=1.5] (-18 - 4, 0 - 4) rectangle +(8, 8);
\draw[mid, rounded corners=5, line width=1.5] (-6 - 4, 0 - 4) rectangle +(8, 8);
\draw[mid, rounded corners=5, line width=1.5] (6 - 4, 0 - 4) rectangle +(8, 8);
\draw[mid, rounded corners=5, line width=1.5] (18 - 4, 0 - 4) rectangle +(8, 8);

\draw[dark, rounded corners=5, line width=1.5] (-24 - 4, -14 - 4) rectangle +(8, 8);
\draw[dark, rounded corners=5, line width=1.5] (-12 - 4, -14 - 4) rectangle +(8, 8);
\draw[dark, rounded corners=5, line width=1.5] (0 - 4, -14 - 4) rectangle +(8, 8);
\draw[dark, rounded corners=5, line width=1.5] (12 - 4, -14 - 4) rectangle +(8, 8);
\draw[dark, rounded corners=5, line width=1.5] (24 - 4, -14 - 4) rectangle +(8, 8);
