...
\begin{tikzpicture}[scale=0.35, thick]
  ...
  \fill [color=light] (-9, 10) .. controls (-2, 10) and (8, 10) .. 
                      (15, 5.07) -- (11, 5.07) .. controls (7, 7) and (-1, 7) .. (-9, 0);
  
  \fill [fill=dark, text=white] (-13, 0) rectangle (-9, 10)
  node[midway, yshift=-4] { $\varpi_{X}^{-1} (B)$ };
  
  %\fill [fill=dark, text=white] (-11, 4) circle (2)
  %node { $A$ };
 
  \draw [color=dark, text=dark, line width=1.5] (11, 5) -- (15, 5)
  node[midway, yshift=-10] { $B$ };
  ...
  \fill [fill=dark, text=white] (-19, -12) rectangle (-5, -8)
  node[midway, yshift=-2] { $\varpi_{Y}^{-1} (B)$ };
  
  \draw [color=dark, text=dark, line width=1.5] (12, -8) -- (12, -12)
  node[midway, xshift=12] { $B$ };
