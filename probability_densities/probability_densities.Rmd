...
A common example, and the one that we will utilize most often is an _addictive_
projection,
$$
\begin{alignat*}{6}
...
\end{alignat*}
$$
then the multiplicative projection becomes an addictive projection,
$$
\begin{align*}
y &= \log(x)
\\
...
I thank Dan Simpson for helpful comments.  I am also indebted for the feedback 
from those who have attended my courses and talks.
