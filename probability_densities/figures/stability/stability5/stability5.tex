...
\begin{tikzpicture}[scale=0.3, thick]               
 ...
 \foreach \i in {0.025, 0.05, ..., 1} {
  ...
  node [color=white, align=center] {Another Stable\\Family on $X$};
  
  \fill[mid] (11.5, 4.75) circle [x radius=5.5, y radius=3.5]
  node [color=white, align=center] {Other Stable\\Family on $X$};
  ...
  \node [color=dark] at (-6, 7.25) { $\pi_{\phi, N}(x)$ };
