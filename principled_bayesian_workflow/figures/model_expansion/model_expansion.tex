...
\begin{tikzpicture}[scale=0.25, thick] 
  ...
  \fill [black] (7 + \dx, 5) circle (0.15)
  node [above right, color=black] { $\pi^{\dagger}$ };
                     
  \draw [->, >=triangle 45, line width=4, color=black] (-17.5, 0) -- +(5, 0);
  ...
  \draw [->, >=triangle 45, line width=4, color=black] (12.5, 0) -- +(5, 0);
