...
\begin{tikzpicture}[scale=0.3, thick]
  ...
  % Step Three
  \fill [rounded corners=2pt, fill=mid, text=white] (-60, 65) rectangle +(20, 3) 
  ...
  \draw [->, >=stealth, gray70, line width=2] (10, 55) -- (10, 48.25);
  ...
  % Step Five
  \fill [rounded corners=2pt, fill=mid, text=white] (-57.5, 50) rectangle +(20, 3) 
  ...
  % Step Six
  \fill [rounded corners=2pt, fill=mid, text=white] (0, 45) rectangle +(20, 3) 
  node [midway, align=center] {6. Simulate Bayesian Ensemble};
  
  \draw [->, >=stealth, white, line width=4] (10, 45) -- (10, 43);
  \draw [->, >=stealth, gray70, line width=2] (10, 45) -- (10, 43.25);
  
  % Step Seven
  \fill [rounded corners=2pt, fill=mid, text=white] (0, 40) rectangle +(20, 3) 
  node [midway, align=center] {7. Prior Checks};
  
  \draw [->, >=stealth, white, line width=4] (10, 40) -- (10, 33);
  \draw [->, >=stealth, gray70, line width=2] (10, 40) -- (10, 33.25);
  ...
  % Step Nine
  \fill [rounded corners=2pt, fill=mid, text=white] (0, 30) rectangle +(20, 3) 
  node [midway, align=center] {9. Fit Simulated Ensemble};
  
  \draw [->, >=stealth, white, line width=4] (10, 30) -- (10, 28);
  \draw [->, >=stealth, gray70, line width=2] (10, 30) -- (10, 28.25);
  
  % Step Ten
  \fill [rounded corners=2pt, fill=mid, text=white] (0, 25) rectangle +(20, 3) 
  node [midway, align=center] {10. Algorithmic Calibration};
  
  \draw [->, >=stealth, white, line width=4] (10, 25) -- (10, 23);
  \draw [->, >=stealth, gray70, line width=2] (10, 25) -- (10, 23.25);
  ...
  % Step Eleven
  \fill [rounded corners=2pt, fill=mid, text=white] (0, 20) rectangle +(20, 3) 
