...
\begin{tikzpicture}[scale=0.20, thick]
  ...
  \draw[white] (-11 + \S, -17) rectangle (61 + \S, 35);
  ...
  \node[] at (0 + \S + 12.5, -12) {$\varpi_{X_{1}}^{-1}(x_{1}) = x_{1} \times X_{2} \times X_{3}$};
  \node[] at (3.3 + \S + 12.5, -14.5) {$\equiv X_{2} \times X_{3} \mid x_{1}$};
