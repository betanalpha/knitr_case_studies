...
kernel, and a Gaussian kernel, amongst other names.
...
in order to stabilize the numerical calculations.  Often the nugget
is taking to be square root of the floating point precision, which
would be $10^{-8}$ for double precision calculations.
...
I thank Dan Simpson for many helpful comments on the case study.
