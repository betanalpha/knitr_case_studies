...
Bayesian workflow, check the diagnostics.
...
I want to end this case study with one last work of caution
...
resolves that problem, but only at the expensive of having
...
for information into our model.  We could achieve that with
