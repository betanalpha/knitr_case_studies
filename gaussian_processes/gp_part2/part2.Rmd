...
In practice we will not know these hyperparameters a prior but will
...
marginal likelihood.  In order to take best advantage of
this flexibility we need to infer Gaussian process
