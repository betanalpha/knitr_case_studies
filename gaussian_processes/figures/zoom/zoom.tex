...
\begin{tikzpicture}[scale=0.3]
  ...
  \begin{scope}
    ...
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_zoom_box.eps}};
  \end{scope}
  ...
  \fill[fill=white] (-13 + \dx, -8) rectangle +(26, 16);

  \begin{scope}
    \clip (-13 + \dx, -8) rectangle (13 + \dx, 8);
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_zoom.eps}};
  \end{scope}
  
  \draw[draw=black, line width=1] (-13 + \dx, -8) rectangle +(26, 16);
