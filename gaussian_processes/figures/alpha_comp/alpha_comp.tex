...
\begin{tikzpicture}[scale=0.3]
  ...
  \node[] at (0 + \dx, 9.5) { Small $\alpha$ };

  \begin{scope}
    \clip (-13 + \dx, -8) rectangle (13 + \dx, 8);
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_low_alpha.eps}};
  \end{scope}
  ...
  \node[] at (0 + \dx, 9.5) { Large $\alpha$ };

  \begin{scope}
    \clip (-13 + \dx, -8) rectangle (13 + \dx, 8);
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_high_alpha.eps}};
  \end{scope}
