...
\begin{tikzpicture}[scale=0.3]
  ...
  \node[] at (0 + \dx, 9.5) { Small $\rho$ };

  \begin{scope}
    \clip (-13 + \dx, -8) rectangle (13 + \dx, 8);
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_low_rho.eps}};
  \end{scope}
  ...
  \node[] at (0 + \dx, 9.5) { Large $\rho$ };

  \begin{scope}
    \clip (-13 + \dx, -8) rectangle (13 + \dx, 8);
    \node at (0 + \dx, 0) {\includegraphics[width=7.8cm]{gp_high_rho.eps}};
  \end{scope}
