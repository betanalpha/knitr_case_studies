...
\begin{scope}[shift={(0, 0)}]
  ...
  \begin{scope}
    \clip (-7, -7) rectangle (7, 6);
        \node at (0, 0) {\includegraphics[width=4.5cm]{normal_mixture_outer_mean_shrinkage.eps}};
  \end{scope}
  
  \node[light, align=center] at (-5.5, 2.4) { $1$ };
  \node[light, align=center] at (-5.5, -5) { $0$ };
  
  \node[light, align=center] at (-5, 5.5) { $\tau_{1}$ };
  \node[light, align=center] at (-4.25, 5.5) { $\tau_{2}$ };
...
\begin{scope}[shift={(18, 0)}]
  ...
  \begin{scope}
    \clip (-7, -7) rectangle (7, 6);
        \node at (0, 0) {\includegraphics[width=4.5cm]{normal_mixture_outer_sd_shrinkage.eps}};
  \end{scope}
