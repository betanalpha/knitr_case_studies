...
\draw[white] (-22 + \dx, -10 + \dy) rectangle (14 + \dx, 6 + \dy);
...
\filldraw[fill=white, draw=dark, line width=1.5, rounded corners=3pt] (-11, -3) rectangle (11, 5);

\node[right] at (2, 3.5) { $k \in \{1, \ldots, K \}$ };
