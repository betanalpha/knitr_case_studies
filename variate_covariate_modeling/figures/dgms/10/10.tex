...
\begin{tikzpicture}[scale=0.2, thick]
  ...
  \foreach \B/\E in {A/B, A/D, B/D, C/D, C/F, D/F} {
  ...
  \node[anchor=west] at (14, 24) { $ \pi(y \mid x, \eta)$ };
  \node[anchor=west] at (14, 16) { $ \pi(x \mid z, \gamma)$ };
  \node[anchor=west] at (14, 8) { $ \pi(z \mid \gamma)$ };
