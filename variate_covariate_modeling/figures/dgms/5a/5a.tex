...
\begin{tikzpicture}[scale=0.2, thick]
  ...
  \draw[white] (-22, 2) rectangle (30, 30);
  
  \draw[dark, line width=1.25, rounded corners=4] (-12, 4) rectangle (12, 28);
  \draw[dark, line width=1.25, rounded corners=4] (-11.25, 12.75) rectangle (3.25, 27.25);
  ...
  \node[anchor=west] at (14, 24) { $ \pi(y_{n} \mid x_{n}, \theta_{k(n)})$ };
  \node[anchor=west] at (14, 16) { $ \pi(x_{n} \mid \theta_{k(n)})$ };
