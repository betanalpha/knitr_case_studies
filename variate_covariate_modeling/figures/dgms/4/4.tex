...
\begin{tikzpicture}[scale=0.2, thick]
  ...
  \draw[dark, line width=1.25, rounded corners=4] (-12, 12) rectangle (12, 28);
  ...
  \node[anchor=west] at (14, 24) { $ \pi(y_{k} \mid x_{k}, \theta)$ };
  \node[anchor=west] at (14, 16) { $ \pi(x_{k} \mid \theta)$ };
