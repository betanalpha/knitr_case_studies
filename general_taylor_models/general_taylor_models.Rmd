...
$$
If environmental temperatures can vary by at most ten degrees Celsius then this
finally implies
$$
\begin{align*}
- \frac{\log 2}{10} &\lessapprox
\beta \, (x - x_{0}) \lessapprox
\frac{\log 2}{10}
\\
- 0.069 &\lessapprox \beta \, (x - x_{0}) \lessapprox 0.069.
\end{align*}
$$
...
$$
\begin{align*}
- \frac{0.1}{10} &\lessapprox \beta \, (x - x_{0}) \lessapprox \frac{0.1}{10}
\\
- 0.01 & \lessapprox \beta \, (x - x_{0}) \lessapprox 0.01
\end{align*}
$$
...
data.  Ultimatley it doesn't look like the observed variates are not far enough
...
$$
\begin{align*}
\log 13.35 &\lessapprox \alpha \lessapprox  \log36.65
...
plot_line_hist(data$X[,2], -4, 4, 0.2, "x2")
plot_line_hist(data$X[,3], -2, 4, 0.2, "x3")

plot(data$X[,1], data$X[,2], pch=16, cex=1.0, col="black",
     main="", xlim=c(-3, 1), xlab="x1", ylim=c(-4, 4), ylab="x2")

plot(data$X[,1], data$X[,3], pch=16, cex=1.0, col="black",
     main="", xlim=c(-3, 1), xlab="x1", ylim=c(-2, 4), ylab="x3")

plot(data$X[,2], data$X[,3], pch=16, cex=1.0, col="black",
     main="", xlim=c(-4, 4), xlab="x2", ylim=c(-2, 4), ylab="x3")

plot(data$X[,1], data$y, pch=16, cex=1.0, col="black",
     main="", xlim=c(-3, 1), xlab="x1", ylim=c(0, 1), ylab="y")

plot(data$X[,2], data$y, pch=16, cex=1.0, col="black",
     main="", xlim=c(-4, 4), xlab="x2", ylim=c(0, 1), ylab="y")
...
Confusing stubborness with thoroughness let's push ahead to the posterior
analysis of the linear probability model in spite of the awkard prior behaviors.
...
conditional_e_prob_retro(data$X[,1], data$y,
                         ...
                         "x1", "", "black")
conditional_e_prob_retro(data$X[,2], data$y,
                         linear_samples$y_pred, -4, 4, 8 / 20,
                         "x2", "", "black")
conditional_e_prob_retro(data$X[,3], data$y,
...
p &= o \, (1 - p)
\\
\frac{ N_{\text{successes}} }{ N }
&=
o \, \frac{ N_{\text{failures}} }{ N }
\\
N_{\text{successes}}
&=
o \, N_{\text{failures}}
