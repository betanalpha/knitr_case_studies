...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \draw[gray70, dashed, line width=1] (-3, 0.5) -- (3, 0.5);
    ...
    \draw[domain={-3:3}, smooth, samples=50, line width=1.25, variable=\x, color=dark] 
      plot ({\x},{ logistic(3 * (0.125 * \x * \x * \x - 1.25 * \x + 0.25 * sin(500 * \x))) - 0.5});
  ...
  \begin{scope}[shift={(9, 0)}]
    ...
    \draw[domain={-3:3}, smooth, samples=50, line width=1.25, variable=\x, color=dark] 
      plot ({\x},{ 0.125 * \x * \x * \x - 1.25 * \x + 0.25 * sin(500 * \x)});

    \draw [->, >=stealth, line width=1.25] (-3.00, -2.015) -- +(0, 4);
    \draw [->, >=stealth, line width=1.25] (-3.015, -2.00) -- +(6, 0);
    
    \node at (-3.75, 0) { $g \circ f(x)$ };
    \node at (0, -2.5) { $x$ };
  \end{scope}
