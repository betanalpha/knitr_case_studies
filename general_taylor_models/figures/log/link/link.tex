...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \draw[gray70, dashed, line width=1] (-2.1, -2) -- (-2.1, 2);
    \node[gray70] at (-2.1, 2.15) { $1$ };
    ...
    \node[light] at (+3, +2) { $\displaystyle \lim_{v \rightarrow +\infty} \log(v) = +\infty$ };
    \node[light] at (-3, -2.5) { $\displaystyle \lim_{v \rightarrow 0} \log(v) = -\infty$ };
